...
export default function Navbar() {
  ...
  return (
    // <header
    //   className={`bg-transparent opacity-100 fixed z-[9999] ${
    ...
    //       </li>
    //       <li className="">
    //         <button className="px-5 text-gray-800 " onClick={toggleTheme}>
    ...
    //   </nav>
    // </header>
    <header className={`bg-blue-500 h-full fixed`}>
      <nav className="flex flex-col justify-between items-center px-5">
        <div className="logo z-40">
          <img
            src="../images/logo-mks-kominfo.webp"
            alt="logo kominfo"
